...
document.getElementById('myLinkComputer').onclick = function () {
    document.getElementById('myThLinkForm').submit();
};

document.getElementById('myLinkIntroduced').onclick = function () {
    document.getElementById('myThLinkForm').submit();
};

document.getElementById('myLinkDiscontinued').onclick = function () {
    document.getElementById('myThLinkForm').submit();
};

document.getElementById('myLinkCompany').onclick = function () {
    document.getElementById('myThLinkForm').submit();
};